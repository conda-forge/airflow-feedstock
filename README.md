...
Once the `conda-forge` channel has been enabled, `airflow, airflow-with-apache-atlas, airflow-with-apache-beam, airflow-with-async, airflow-with-atlas, airflow-with-cgroups, airflow-with-dask, airflow-with-github_enterprise, airflow-with-google_auth, airflow-with-kerberos, airflow-with-ldap, airflow-with-password, airflow-with-rabbitmq, airflow-with-sentry, airflow-with-statsd, airflow-with-tableau, airflow-with-virtualenv, apache-airflow` can be installed with:

```
conda install airflow airflow-with-apache-atlas airflow-with-apache-beam airflow-with-async airflow-with-atlas airflow-with-cgroups airflow-with-dask airflow-with-github_enterprise airflow-with-google_auth airflow-with-kerberos airflow-with-ldap airflow-with-password airflow-with-rabbitmq airflow-with-sentry airflow-with-statsd airflow-with-tableau airflow-with-virtualenv apache-airflow
```
