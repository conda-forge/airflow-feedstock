      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2673&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/airflow-feedstock?branchName=master&jobName=linux&configuration=linux_python3.6.____cpython" alt="variant">
                </a>
              </td>
            </tr><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2673&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/airflow-feedstock?branchName=master&jobName=linux&configuration=linux_python3.7.____cpython" alt="variant">
                </a>
              </td>
            </tr><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2673&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/airflow-feedstock?branchName=master&jobName=linux&configuration=linux_python3.8.____cpython" alt="variant">
                </a>
              </td>
            </tr><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2673&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/airflow-feedstock?branchName=master&jobName=osx&configuration=osx_python3.6.____cpython" alt="variant">
                </a>
              </td>
            </tr><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2673&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/airflow-feedstock?branchName=master&jobName=osx&configuration=osx_python3.7.____cpython" alt="variant">
                </a>
              </td>
            </tr><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2673&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/airflow-feedstock?branchName=master&jobName=osx&configuration=osx_python3.8.____cpython" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
| [![Conda Recipe](https://img.shields.io/badge/recipe-airflow--with--aws-green.svg)](https://anaconda.org/conda-forge/airflow-with-aws) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/airflow-with-aws.svg)](https://anaconda.org/conda-forge/airflow-with-aws) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/airflow-with-aws.svg)](https://anaconda.org/conda-forge/airflow-with-aws) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/airflow-with-aws.svg)](https://anaconda.org/conda-forge/airflow-with-aws) |
...
| [![Conda Recipe](https://img.shields.io/badge/recipe-airflow--with--azure_data_lake-green.svg)](https://anaconda.org/conda-forge/airflow-with-azure_data_lake) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/airflow-with-azure_data_lake.svg)](https://anaconda.org/conda-forge/airflow-with-azure_data_lake) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/airflow-with-azure_data_lake.svg)](https://anaconda.org/conda-forge/airflow-with-azure_data_lake) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/airflow-with-azure_data_lake.svg)](https://anaconda.org/conda-forge/airflow-with-azure_data_lake) |
...
| [![Conda Recipe](https://img.shields.io/badge/recipe-airflow--with--flask_oauth-green.svg)](https://anaconda.org/conda-forge/airflow-with-flask_oauth) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/airflow-with-flask_oauth.svg)](https://anaconda.org/conda-forge/airflow-with-flask_oauth) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/airflow-with-flask_oauth.svg)](https://anaconda.org/conda-forge/airflow-with-flask_oauth) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/airflow-with-flask_oauth.svg)](https://anaconda.org/conda-forge/airflow-with-flask_oauth) |
...
Once the `conda-forge` channel has been enabled, `airflow, airflow-with-async, airflow-with-atlas, airflow-with-aws, airflow-with-azure-mgmt-containerinstance, airflow-with-azure_blob_storage, airflow-with-azure_cosmos, airflow-with-azure_data_lake, airflow-with-cassandra, airflow-with-celery, airflow-with-cgroups, airflow-with-cloudant, airflow-with-crypto, airflow-with-dask, airflow-with-databricks, airflow-with-datadog, airflow-with-docker, airflow-with-druid, airflow-with-elasticsearch, airflow-with-emr, airflow-with-flask_oauth, airflow-with-grpc, airflow-with-hashicorp, airflow-with-hdfs, airflow-with-hive, airflow-with-jdbc, airflow-with-jenkins, airflow-with-jira, airflow-with-kerberos, airflow-with-kubernetes, airflow-with-ldap, airflow-with-mongo, airflow-with-mssql, airflow-with-mysql, airflow-with-oracle, airflow-with-pagerduty, airflow-with-papermill, airflow-with-password, airflow-with-postgres, airflow-with-qds, airflow-with-rabbitmq, airflow-with-redis, airflow-with-salesforce, airflow-with-samba, airflow-with-segment, airflow-with-sendgrid, airflow-with-sentry, airflow-with-slack, airflow-with-snowflake, airflow-with-ssh, airflow-with-statsd, airflow-with-vertica, airflow-with-virtualenv, airflow-with-webhdfs, airflow-with-winrm` can be installed with:

```
conda install airflow airflow-with-async airflow-with-atlas airflow-with-aws airflow-with-azure-mgmt-containerinstance airflow-with-azure_blob_storage airflow-with-azure_cosmos airflow-with-azure_data_lake airflow-with-cassandra airflow-with-celery airflow-with-cgroups airflow-with-cloudant airflow-with-crypto airflow-with-dask airflow-with-databricks airflow-with-datadog airflow-with-docker airflow-with-druid airflow-with-elasticsearch airflow-with-emr airflow-with-flask_oauth airflow-with-grpc airflow-with-hashicorp airflow-with-hdfs airflow-with-hive airflow-with-jdbc airflow-with-jenkins airflow-with-jira airflow-with-kerberos airflow-with-kubernetes airflow-with-ldap airflow-with-mongo airflow-with-mssql airflow-with-mysql airflow-with-oracle airflow-with-pagerduty airflow-with-papermill airflow-with-password airflow-with-postgres airflow-with-qds airflow-with-rabbitmq airflow-with-redis airflow-with-salesforce airflow-with-samba airflow-with-segment airflow-with-sendgrid airflow-with-sentry airflow-with-slack airflow-with-snowflake airflow-with-ssh airflow-with-statsd airflow-with-vertica airflow-with-virtualenv airflow-with-webhdfs airflow-with-winrm
```
